...
class ListAll extends React.Component {
    ...
    componentWillMount() {
        ...
        this.props.indexListNextPage('http://192.168.21.22/cloud/pay?method=payList', 'post', obj)
                    ...
                    PullToRefresh={<PullToRefresh
                        ...
                        onRefresh={
                            () => {
                                ...
                                this.props.clearOrdersList();
                                this.props.indexListNextPage('http://192.168.21.22/cloud/pay?method=payList', 'post', {
